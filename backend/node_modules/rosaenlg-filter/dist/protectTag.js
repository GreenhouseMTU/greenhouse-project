...
exports.processProtectHtmlTags = void 0;
const startProtect = '<protect>';
const endProtect = '</protect>';
function removeNestedProtectHtmlTags(input, start = 0, opened = 0) {
    // ending
...
function processProtectHtmlTags(input) {
    const cleaned = removeNestedProtectHtmlTags(input);
    return cleaned.replace(/<protect>/g, '§').replace(/<\/protect>/g, '§');
}
exports.processProtectHtmlTags = processProtectHtmlTags;
//# sourceMappingURL=protectTag.js.map