...
class SavePoint {
    constructor(htmlBefore, hasSaid, triggeredRefs, refGenderMap, refNumberMap, rndNextPos, nextRefs, synoSeq, synoTriggered, verbParts, verbPrefixes, isEvaluatingEmpty, isEvaluatingNextRep, isEvaluatingChoosebest) {
...
class SaveRollbackManager {
    constructor() {
        this.spy = undefined;
        this.saidManager = undefined;
        this.refsManager = undefined;
        this.genderNumberManager = undefined;
        this.randomManager = undefined;
        this.synManager = undefined;
        this.verbsManager = undefined;
    ...
    saveSituation(context) {
        ...
        const savePoint = new SavePoint(this.getSpy().getPugHtml(), this.saidManager.getHasSaidMap(), this.refsManager.getTriggeredRefs(), this.genderNumberManager.getRefGenderMap(), this.genderNumberManager.getRefNumberMap(), this.randomManager.getRndNextPos(), this.refsManager.getNextRefs(), this.synManager.getSynoSeq(), this.synManager.getSynoTriggered(), this.verbsManager.getVerbPartsList(), this.verbsManager.getVerbPrefixesList(), this.isEvaluatingEmpty, this.isEvaluatingNextRep, this.isEvaluatingChoosebest);
    ...
    rollback() {
        ...
        this.verbsManager.setVerbPrefixes(savePoint.verbPrefixes);
