...
function getRosaeNlgVersion() {
    return '4.4.0'; // will be replaced by gulp when copied into dist/
}
...
class NlgLib {
    ...
    constructor(params) {
        this.embeddedLinguisticResources = undefined;
        this._spy = undefined;
        ...
        this._randomManager = new RandomManager_1.RandomManager(this.randomSeed);
        ...
        const iso2 = (0, rosaenlg_commons_1.getIso2fromLocale)(this.language);
        this._languageImpl = (0, languageHelper_1.languageImplfromIso2)(iso2);
        {
            // referencing libs for custom user usage
            // for numeral
            this.numeral = numeral_1.default;
        }
        this._saveRollbackManager = new SaveRollbackManager_1.SaveRollbackManager();
        this._genderNumberManager = new GenderNumberManager_1.GenderNumberManager(this.languageImpl);
        this._helper = new Helper_1.Helper(this.genderNumberManager, this.saveRollbackManager, this.languageImpl, params.renderDebug);
        this._synManager = new SynManager_1.SynManager(this.randomManager, this.saveRollbackManager, this.helper, {
            defaultSynoMode: params.defaultSynoMode || 'random',
        });
        this._verbsManager = new VerbsManager_1.VerbsManager(this.languageImpl, this.genderNumberManager, this.synManager, this.saveRollbackManager, this.helper);
        this._choosebestManager = new ChoosebestManager_1.ChoosebestManager(this.language, this.helper, this.saveRollbackManager, this.randomManager, params.defaultAmong || 5);
        this._saidManager = new SaidManager_1.SaidManager();
        this._refsManager = new RefsManager_1.RefsManager(this.saveRollbackManager, this.genderNumberManager, this.randomManager);
        this._adjectiveManager = new AdjectiveManager_1.AdjectiveManager(this.languageImpl, this.genderNumberManager, this.synManager, this.saveRollbackManager, this.helper);
        this._possessiveManager = new PossessiveManager_1.PossessiveManager(this.languageImpl, this.genderNumberManager, this.refsManager, this.helper);
        this._valueManager = new ValueManager_1.ValueManager(this.languageImpl, this.refsManager, this.genderNumberManager, this.randomManager, this.adjectiveManager, this.helper, this.possessiveManager, this.synManager, this.saveRollbackManager, this.languageImpl.languageCommon.constants);
        this._asmManager = new AsmManager_1.AsmManager(this.saveRollbackManager, this.randomManager, this.valueManager, this.helper);
        this._sentenceManager = new SentenceManager_1.SentenceManager(this.languageImpl, this.verbsManager, this.valueManager, this.adjectiveManager, this.synManager, this.helper);
    ...
    getFiltered() {
        return (0, rosaenlg_filter_1.filter)(this.spy.getPugHtml(), this.languageImpl.getLanguageCommon(), { renderDebug: this.renderDebug });
    }
    getSaidManager() {
        return this._saidManager;
    }
