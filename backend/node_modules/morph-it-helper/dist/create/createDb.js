...
const lineReader = (0, readline_1.createInterface)({
    input: (0, fs_1.createReadStream)(morphItPath, { encoding: 'latin1' }),
});
...
try {
    lineReader
        ...
        */
        ...
        .on('close', function () {
        (0, fs_1.writeFileSync)('resources_pub/nouns.json', JSON.stringify(nouns), 'utf8');
        (0, fs_1.writeFileSync)('resources_pub/adjectives.json', JSON.stringify(adjectives), 'utf8');
        (0, fs_1.writeFileSync)('resources_pub/pastParticiples.json', JSON.stringify(pastParticiples), 'utf8');
        console.log('done.');
    });
}
catch (err) {
