...
class CodeGenHelper {
    ...
    constructor(language, embedResources) {
        ...
        this.languageCodeGen = (0, languageCodeGenHelper_1.buildLanguageCodeGen)((0, languageCodeGenHelper_1.getIso2fromLocale)(language));
    ...
    getParsedExpr(args) {
        ...
        const parsed = (0, recast_1.parse)(args);
