...
exports.LanguageCodeGenItalian = void 0;
...
class LanguageCodeGenItalian extends LanguageCodeGen_1.LanguageCodeGen {
    constructor() {
        super(...arguments);
        this.iso2 = 'it';
    ...
    getVerbInfo(verb) {
        return (0, italian_verbs_1.getVerbInfo)(verbs_json_1.default, verb);
    }
    getWordInfo(word) {
        return (0, italian_words_1.getWordInfo)(words_json_1.default, word);
    }
    getAdjectiveInfo(adjective) {
        return (0, italian_adjectives_1.getAdjectiveInfo)(adjectives_json_1.default, adjective);
    }
}
exports.LanguageCodeGenItalian = LanguageCodeGenItalian;
//# sourceMappingURL=LanguageCodeGenItalian.js.map