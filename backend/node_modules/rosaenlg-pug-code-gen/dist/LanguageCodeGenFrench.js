...
class LanguageCodeGenFrench extends LanguageCodeGen_1.LanguageCodeGen {
    ...
    getVerbInfo(verb) {
        return (0, french_verbs_1.getVerbInfo)(conjugations_json_1.default, verb);
    }
    getWordInfo(word) {
        return (0, french_words_1.getWordInfo)(words_json_1.default, word);
    }
    getAdjectiveInfo(adjective) {
        // NB no need to give an custom list here
        return (0, french_adjectives_wrapper_1.getAdjectiveInfo)(adjective, undefined);
    }
}
